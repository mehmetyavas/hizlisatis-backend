...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230322194529_JWTConfig2")]
    partial class JWTConfig2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.Sale", b =>
                {
                    b.HasOne("Entities.Concrete.Employee", "Employees")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Entities.Concrete.Payment", "Payments")
                        .WithMany()
                        .HasForeignKey("PaymentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.Concrete.Shift", "Shifts")
                        .WithMany()
